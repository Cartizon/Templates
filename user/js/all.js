	...
	function init_classic_menu() {
		...
		mobile_nav.click(function() {
			if (desktop_nav.hasClass('js-opened')) {
				desktop_nav
					.slideUp('slow', 'easeOutExpo')
					.removeClass('js-opened');
				$(this).removeClass('active');
			} else {
				desktop_nav
					.slideDown('slow', 'easeOutQuart')
					.addClass('js-opened');
	...
	(function($) {
		...
		function syncPosition(el) {
			...
			$('.fullwidth-slideshow-pager')
				...
				.addClass('synced');
			if (
				$('.fullwidth-slideshow-pager').data('owlCarousel') !==
				undefined
			) {
				center(current);
			}
